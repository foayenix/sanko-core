...
| Training/evaluation | `export-training-data.js`, `export-vision-data.js`, `compare-vision.js`, `draft-eval-cases.js`, `promote-model.js` | Real exports/evaluations require configured services and reviewed input; never commit raw practitioner exports. |
